...
<body>
  ...
  <main class="login-container">
    ...
    <form action="/php/query/registrazione.php" method="post" id="form">
      ...
      <input type="text" id="new_surname" name="new_surname" placeholder="Rossi" >
      <label for="new_username" class="error_text">Username:</label>
      <input type="text" id="new_username" name="new_username"  placeholder="erMarione" required>
      <label for="new_email" class="error_text">Email:</label>
      <input type="email" id="new_email" name="new_email"  placeholder="mariorossi@esempio.it" required>
      <label for="new_password">Password:</label>
      <input type="password" id="new_password" name="new_password" placeholder="1234" required>
      <br>
      <input type="submit" class="button primary" value="Registrati">
    </form>
    <br>
